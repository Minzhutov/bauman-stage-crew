...
function seed() {
  ...
  const positionDefs = [
    ...
    ['Техник по звуку', 'Коммутация звукового оборудования и микрофонов на площадке', 'sound'],
    ...
    ['Техник по свету', 'Монтаж, коммутация и фокусировка светового оборудования', 'light'],
    ...
    ['Техник по экранам', 'Монтаж и обслуживание LED-экранов и проекционного оборудования', 'screens'],
    ...
    ['Монтировщик', 'Погрузка, монтаж и демонтаж оборудования', 'stage'],
  ...
  const crewDefs = [
    ...
    ['Дмитрий Орлов', 'dmitry.orlov@example.com', 'МТ4-21', ['Риггер', 'Монтировщик', 'Электрик'], 'user'],
